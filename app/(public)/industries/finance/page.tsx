...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Fintech dashboards, payment gateways, trading systems.",
  ...
  return (
    <>
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <Reveal type="fade-up" delay={0.05}>
              <h1 className="mt-6 text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
                Next-generation{' '}
                <span className="text-gradient-gold">Fintech</span> solutions
              </h1>
            </Reveal>
            <Reveal type="fade-up" delay={0.1}>
              <p className="mt-4 max-w-2xl text-lg text-muted-foreground mx-auto">
                Fintech dashboards, secure payment gateways, and high-performance trading systems built for the modern financial era.
              </p>
            </Reveal>
      ...
      <section className="relative overflow-hidden border-t border-border/40 bg-white">
        <div aria-hidden className="pointer-events-none absolute left-1/2 top-1/2 h-72 w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-100/30 blur-[100px]" />
        <Container className="relative py-16 sm:py-20">
          <Reveal type="fade-up" className="mx-auto max-w-2xl text-center">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-blue-200/40 bg-blue-50/80 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-blue-600 shadow-sm">
              <Sparkles className="size-3" aria-hidden />
              Let's Talk
            </span>
            <h2 className="mt-5 text-3xl font-semibold tracking-tight sm:text-4xl">
              Ready to disrupt the{' '}
              <span className="text-gradient-gold">Finance</span> space?
            </h2>
