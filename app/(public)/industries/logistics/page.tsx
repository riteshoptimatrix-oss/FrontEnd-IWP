...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Fleet tracking, warehouse management, inventory systems.",
...
export default function LogisticsPage() {
  return (
    <>
      {/* ── Hero ── */}
      <Section className="relative min-h-[65svh] flex items-center overflow-hidden bg-gradient-to-b from-orange-50/30 via-white to-white">
        <ShapesHome />
        ...
        <Container className="relative">
          <div className="mx-auto max-w-3xl text-center">
            <Reveal type="fade-up">
              <span className="inline-flex items-center gap-2 rounded-full border border-orange-200/30 bg-gradient-to-r from-orange-100/50 to-orange-50/50 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-orange-600 shadow-sm">
            ...
            <Reveal type="fade-up" delay={0.1}>
              <p className="mt-4 max-w-2xl text-lg text-muted-foreground mx-auto">
                Real-time fleet tracking, robust warehouse management, and intelligent inventory systems for modern logistics.
              </p>
            </Reveal>
      ...
      <section className="relative overflow-hidden border-t border-border/40 bg-white">
        <div aria-hidden className="pointer-events-none absolute left-1/2 top-1/2 h-72 w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-100/30 blur-[100px]" />
        <Container className="relative py-16 sm:py-20">
          <Reveal type="fade-up" className="mx-auto max-w-2xl text-center">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-orange-200/40 bg-orange-50/80 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-orange-600 shadow-sm">
