...
export default function PortfolioPage() {
  return (
    <>
      {/* ── Hero ── */}
      <Section className="relative min-h-[50svh] py-12 lg:py-16 flex items-center overflow-hidden bg-gradient-to-b from-blue-50/30 via-white to-white">
        <ShapesHome />
        ...
        <div aria-hidden className="pointer-events-none absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-background to-transparent" />
      </Section>
