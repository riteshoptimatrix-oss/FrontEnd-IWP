...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Fast, accessible and beautifully crafted marketing and brand websites that convert visitors into customers.",
  path: "/what-we-do/web-development",
});

export default function WebDevelopmentPage() {
  const service = allServices.find((s) => s.id === "web-development")!;
